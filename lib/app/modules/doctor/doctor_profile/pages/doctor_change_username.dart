...
class DoctorChangeUsername extends GetView<DoctorChangeUserNameController> {
  const DoctorChangeUsername({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DoctorChangeUserNameController>(initState: (_) {
      controller.setUserName(Get.find<DoctorEditProfileController>()
          .userProfileModel
          .value!
          .userProfile!
          .username);
              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GetBuilder<DoctorChangeUserNameController>(
                          init: DoctorChangeUserNameController(),
                          builder: (ctrl) {
