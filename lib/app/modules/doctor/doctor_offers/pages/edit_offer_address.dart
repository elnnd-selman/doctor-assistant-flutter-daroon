...
class EditOfferAddress extends GetView<OfferEditController> {
  EditOfferAddress({super.key});
            ...
            onPressed: () {
              Get.dialog(
                CustomDialogBox(
                  ...
                  onPressedConfirm: () {
                    controller.updateDoctorOffer(
                        context: context, data: offerData);
                  },
                      ...
                      if (controller.selectedAddressID.value == '') {
                        ...
                        Get.dialog(
                          CustomDialogBox(
                            ...
                            subTitle:
                                'After you save the change you\nshould wait until the admin\napprove your change, are you\nsure you want to save the\nchange ??',
                          ),
                          barrierColor: AppColors.blackBGColor.withOpacity(0.5),
                        );
                      }
