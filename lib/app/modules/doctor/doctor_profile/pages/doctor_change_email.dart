...
class DoctorChangeEmail extends GetView<DoctorChangeEmailController> {
  const DoctorChangeEmail({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DoctorChangeEmailController>(initState: (_) {
      controller.setUserEmail(Get.find<DoctorEditProfileController>()
          .userProfileModel
          .value!
          .userProfile!
          .email);
